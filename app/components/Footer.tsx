    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-xl font-bold mb-4">Axon Software</h3>
            <p className="text-gray-400 leading-relaxed">
              Building software solutions for your personal needs. 
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+40786908232" className="hover:text-blue-400 transition-colors">
                  +40 786 908 232
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:pieleanuandrei2001@gmail.com" className="hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/company/axon-software-company"
                target="_blank"
                rel="noopener noreferrer"
        ...
        {/* <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Axon Software. All rights reserved.
            </p>
